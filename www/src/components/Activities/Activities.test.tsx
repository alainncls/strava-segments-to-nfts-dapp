...
test("renders activities", () => {
  render(<Activities activities={activities} checkForSegments={checkForSegments} displaySegments={displaySegments} />);
...
test("renders activities with ability to display segments", () => {
  activities[0].segments = [{ id: 123, title: "title", distance: 123, type: "type" }];
  render(<Activities activities={activities} checkForSegments={checkForSegments} displaySegments={displaySegments} />);
