      ...
      <Navbar collapseOnSelect fixed={"bottom"} expand={"lg"} bg={"dark"}>
        <Container>
          <Navbar.Collapse aria-controls={"responsive-navbar-nav"}>
            ...
            <Nav>
              <Nav.Item>
                <img alt={"Powered by Strava logo"} src={poweredByStrava} height={24} />
              </Nav.Item>
              <Nav.Item>
                <a
                  className="ms-3"
              ...
              <Nav.Item>
                <a className="ms-3" href="https://twitter.com/Alain_Ncls" target="_blank" rel="noreferrer">
                  <i className="bi bi-twitter text-white"></i>
                </a>
              </Nav.Item>
              <Nav.Item>
                <a className="ms-3" href="https://www.linkedin.com/in/alainnicolas/" target="_blank" rel="noreferrer">
